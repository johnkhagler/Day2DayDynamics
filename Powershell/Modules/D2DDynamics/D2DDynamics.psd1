...
FunctionsToExport = @('Get-AXAutoRunXML', 'Start-AXAutoRun', 'Start-AXBuildCompile', 'Compile-AXCIL', 'Sync-AXDB', 'Compile-AXAOT', 'Clean-AXArtifacts', 'Import-AXXPO', 'Import-AXLabelFile', 'Sync-AXTFSWorkingFolder', 'Restore-AXDatabase', 'Combine-AXXPO', 'Start-AXMSBuildImport', 'Compile-AXXppNode', 'Import-AXVSProject', 'Send-Email')
